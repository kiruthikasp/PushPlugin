...
PushNotification.prototype.tone = function(successCallback, errorCallback) {
    ...
    if (typeof errorCallback !== 'function')  {
        console.log('PushNotification.tone failure: failure parameter not a function');
        return;
    }

    if (typeof successCallback !== 'function') {
        console.log('PushNotification.tone failure: success callback parameter must be a function');
        return;
    }

    exec(successCallback, errorCallback, 'PushNotification', 'tone',[]);
};
